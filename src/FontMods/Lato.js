...
class Lato extends Component{

	state = {
		showFonts : [
			{value : "All work no play makes jack a dull boy" , family : "Lato" , css : "Lato"}
		],
		showMenu : false
	}
	...
	handleInput = (e) => {
		this.setState({
			showFonts : [
				{value : e.target.value , family : "Lato" , btn : "+ Select style"}
			]
		})
	}
	...
	render(){
		return(
			<div className = "AllFonts">
				<div className = "fontBodyla">
					<h1>Lato</h1>
					<p>Designed by <b>Łukasz Dziedzic</b></p>
					<br/>
					<hr/>
					<br/>
				</div>

...
class PTSans extends Component{

	state = {
		showFonts : [
			{value : "All work no play makes jack a dull boy" , family : "PT Sans" , css : "PT+Sans"},
			{value : "All work no play makes jack a dull boy" , family : "PT Serif" , css : "PT+Serif"},
			{value : "All work no play makes jack a dull boy" , family : "PT Sans Narrow" , css : "PT+Sans+Narrow"},
			{value : "All work no play makes jack a dull boy" , family : "PT Sans Caption" , css : "PT+Sans+Caption"},
			{value : "All work no play makes jack a dull boy" , family : "PT Serif Caption" , css : "PT+Serif+Caption"}
		],
		showMenu : false
	}
	...
	handleInput = (e) => {
		this.setState({
			showFonts : [
				{value : e.target.value , family : "PT Sans" , btn : "+ Select style"},
				{value : e.target.value , family : "PT Serif" , btn : "+ Select style"},
				{value : e.target.value , family : "PT Sans Narrow" , btn : "+ Select style"},
				{value : e.target.value , family : "PT Sans Caption" , btn : "+ Select style"},
				{value : e.target.value , family : "PT Serif Caption" , btn : "+ Select style"}
			]
		})
	}

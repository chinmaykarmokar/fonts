...
class Pangolin extends Component{
	...
	state = {
		showFonts : [
			{value : "All work no play makes jack a dull boy" , family : "Pangolin" , css : "Pangolin"}
		],
		showMenu : false
	}
	...
	handleInput = (e) => {
		this.setState({
			showFonts : [
				{value : e.target.value , family : "Pangolin" , btn : "+ Select style"}
			]
		})
	}
	...
	render(){
		return(
			<div className = "AllFonts">
				<div className = "fontBodypa">
					<h1>Pangolin</h1>
					<p>Designed by <b>Kevin Burke</b></p>
					<br/>
					<hr/>
					<br/>
				</div>

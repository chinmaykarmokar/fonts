...
class Oxygen extends Component{
	...
	state = {
		showFonts : [
			{value : "All work no play makes jack a dull boy" , family : "Oxygen" , css : "Oxygen"},
			{value : "All work no play makes jack a dull boy" , family : "Oxygen Mono" , css : "Oxygen+Mono"}
		],
		showMenu : false
	}
	...
	handleInput = (e) => {
		this.setState({
			showFonts : [
				{value : e.target.value , family : "Oxygen" , btn : "+ Select style"},
				{value : e.target.value , family : "Oxygen Mono" , btn : "+ Select style"}
			]
		})
	}

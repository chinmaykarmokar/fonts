...
class Cookie extends Component{
	state = {
		showFonts : [
			{value : "All work no play makes jack a dull boy" , family : "Cookie" , css : "Cookie"},
		],
		showMenu : false
	}
	...
	handleInput = (e) => {
		this.setState({
			showFonts : [
				{value : e.target.value , family : "Cookie" , btn : "+ Select style"},
			]
		})
	}
							...
							<Row>
								<Col md = {12}>
									<Card className = "MyCard">
									  	<Card.Body>
									    	<Card.Title><b>Embed</b></Card.Title>
									     		 ...
									     		 <Tabs defaultActiveKey="home" id="uncontrolled-tab-example">
									     		   <Tab eventKey="home" title="<link>">
									     		     ...
									     		     <p style = {{fontFamily : data.src, fontSize : "11px"}}>
									     		     	{data.b1}link href="https://fonts.googleapis.com/css2?family={data.family}&display=swap" rel="stylesheet"{data.b2}
									     		     </p>
									     		   </Tab>
									     		   <Tab eventKey="profile" title="@import">
									     		     ...
									     		     <p style = {{fontFamily : data.src, fontSize : "11px"}}>
									     		     	@import url('https://fonts.googleapis.com/css2?family={data.family}&display=swap');
									     		     </p>
									     		   </Tab>
									     		 </Tabs>
									    	</Card.Text>

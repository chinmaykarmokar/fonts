...
class Sriracha extends Component{

	state = {
		showFonts : [
			{value : "All work no play makes jack a dull boy" , family : "Sriracha" , css : "Sriracha"}
		],
		showMenu : false
	}
	...
	handleInput = (e) => {
		this.setState({
			showFonts : [
				{value : e.target.value , family : "Sriracha" , btn : "+ Select style"},
			]
		})
	}
	...
	render(){
		return(
			<div className = "AllFonts">
				<div className = "fontBodysri">
					<h1>Sriracha</h1>
					<p>Designed by <b>Cadson Demak</b></p>
					<br/>
					<hr/>
					<br/>
				</div>

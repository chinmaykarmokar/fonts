...
class Roboto extends Component{
		state = {
			showFonts : [
				{value : "All work no play makes jack a dull boy" , family : "Roboto" , css : "Roboto"},
				{value : "All work no play makes jack a dull boy" , family : "Roboto Mono" , css : "Roboto+Mono"},
				{value : "All work no play makes jack a dull boy" , family : "Roboto Condensed" , css : "Roboto+Condensed"},
				{value : "All work no play makes jack a dull boy" , family : "Roboto Slab" , css : "Roboto+Slab"}
			],
			showMenu : false
		}
		...
		handleInput = (e) => {
			this.setState({
				showFonts : [
					{value : e.target.value , family : "Roboto" , btn : "+ Select style"},
					{value : e.target.value , family : "Roboto Mono" , btn : "+ Select style"},
					{value : e.target.value , family : "Roboto Condensed" , btn : "+ Select style"},
					{value : e.target.value , family : "Roboto Slab" , btn : "+ Select style"}
				]
			})
		}

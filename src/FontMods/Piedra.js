...
class Piedra extends Component{

	state = {
		showFonts : [
			{value : "All work no play makes jack a dull boy" , family : "Piedra" , css : "Piedra"}
		],
		showMenu : false
	}
	...
	handleInput = (e) => {
		this.setState({
			showFonts : [
				{value : e.target.value , family : "Piedra" , btn : "+ Select style"}
			]
		})
	}
